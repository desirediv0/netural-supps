...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>If you didn't request this password reset, please contact our support team immediately at support@Natural Supps</p>
...
<body>
  ...
  data.shippingAddress.state
        ...
        <div class="footer">
            © ${new Date().getFullYear()} Natural Supps | Premium Health Supplements<br>
            Questions? Contact our customer support at support@Natural Supps
        </div>
    </div>
</body>
</html>
