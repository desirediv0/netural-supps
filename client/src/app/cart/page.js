  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {!isAuthenticated && cart.items.length > 0 && (
        <div className="bg-gradient-to-r from-orange-500/10 to-orange-500/10 border border-orange-200 p-6 rounded-lg flex items-start mb-6 shadow-sm">
          <div className="flex-shrink-0 mr-4">
            <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-orange-500 rounded-full flex items-center justify-center">
              <svg
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/login?redirect=cart">
                <Button className="bg-gradient-to-r from-orange-500 to-orange-700 hover:from-orange-600 hover:to-orange-600 text-white font-semibold px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105">
                  Log In to Continue
                </Button>
              </Link>
              <Link href="/register?redirect=cart">
                <Button
                  variant="outline"
                  className="border-2 border-gray-300 hover:border-primary text-gray-700 hover:text-white font-semibold px-6 py-3 rounded-lg transition-all duration-200"
                >
                  Create Account
                </Button>
              </Link>
      ...
      {/* Show merge progress */}
      {mergeProgress && (
        <div className="bg-orange-50 p-4 rounded-md flex items-start mb-6">
          <Loader2 className="text-orange-500 mr-3 mt-0.5 flex-shrink-0 animate-spin" />
          <div>
            <h2 className="text-lg font-semibold text-orange-700">
              Merging Cart
            </h2>
            <p className="text-orange-600">{mergeProgress}</p>
          </div>
        </div>
      )}
